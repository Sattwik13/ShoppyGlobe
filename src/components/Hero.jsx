...
const Hero = () => {
  return (
    <div>
        <section
            className="overflow-hidden p-5 bg-[url(https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?q=80&w=2670&auto=format&fit=crop)] bg-cover bg-top bg-no-repeat"
            >
